...
class BlogCategoryController extends Controller
{
    ...
    public function blogCategory(Request $request)
    {
        try {
            ...
            return view('core::base.tenant.blog.category.blog_category', compact('bcategories'));
        } catch (\Exception $e) {
    ...
    public function addBlogCategory()
    {
        try {
            ...
            return view('core::base.tenant.blog.category.add_blog_category', compact('categories'));
        } catch (\Exception $e) {
    ...
    public function storeBlogCategory(BlogCategoryRequest $request)
    {
        try {
            DB::beginTransaction();
            $this->blogCategory_repository->addNewCategory($request);
            DB::commit();
    ...
    public function editBlogCategory(Request $request, $id)
    {
        try {
            if ($request->id && is_numeric($request->id) && $request->lang) {
                ...
                return view('core::base.tenant.blog.category.edit_blog_category', compact('categories', 'bcategory', 'languages', 'lang'));
            } else {
