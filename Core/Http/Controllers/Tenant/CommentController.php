...
class CommentController extends Controller
{
    ...
    public function comment(Request $request)
    {
        try {
            ...
            return view('core::base.tenant.blog.comment.comment', compact('comments'));
        } catch (\Exception $e) {
            toastNotification('error', translate('Blog Comment Not Found'));
            return redirect()->back();
        }
    ...
    public function editComment($id)
    {
        try {
            if (is_numeric($id)) {
                ...
                return view('core::base.tenant.blog.comment.edit_comment', compact('comment'));
            } else {
    ...
    {
        return view('core::base.tenant.blog.settings.comment_setting');
    }
