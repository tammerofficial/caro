...
class GeneralSettingsController extends Controller
{
    ...
    public function generalSettings()
    {
        ...
        for ($i = 0; $i < sizeof($media_settings_value); $i++) {
            ...
            } elseif ($media_settings_value[$i]->name == 'login_bg_image') {
                $data['login_bg_image'] = $media_settings_value[$i]->path;
                $data['login_bg_image_alt'] = $media_settings_value[$i]->alt;
                $data['login_bg_image_id'] = $media_settings_value[$i]->file_id;
