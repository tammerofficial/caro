...
@section('main_content')
    <div class="app-items">
        <div class="align-items-center border-bottom2 d-flex flex-wrap gap-10 justify-content-between mb-4 pb-3">
            <h4><i class="icofont-plugin"></i> {{ translate('Plugins') }}</h4>
            @if (!isTenant())
                ...
                @foreach ($plugins as $plugin)
                    @if ($plugin['type'] == 'saas')
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 mb-30">
                            <div class="app-item">
                                <div class="app-icon">
                                    @if (File::exists(base_path('/plugins' . '/' . $plugin['location'] . '/banner.png')))
        ...
        <div class="row">
            @if (!isTenant())
                <div class="col-lg-12 mt-4 mb-2 pb-3">
                    <h4><i class="icofont-plugin"></i> {{ translate('Tenant Plugins') }}</h4>
                </div>
            @endif
            @foreach ($plugins as $plugin)
                @if (
