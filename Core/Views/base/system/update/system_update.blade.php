@php
    ...
    $is_any_store_backdated = checkIfAnyStoreIsNotUpdated();
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('app.system.update.file.submit') }}"
                        ...
                        @if ($is_any_store_backdated)
                            <p class="alert alert-danger">1. Some of your stores are not updated, please update them first and then try to update the system</p>
                        @endif
                        @if ($upload_max_filesize < $required_upload_max_filesize)
                            <p class="alert alert-danger">2. Please make sure, your server php "upload_max_filesize" value
                                is
                                grater
                        ...
                        @endif
                        @if ($post_max_size < $required_post_max_size)
                            <p class="alert alert-danger">3. Please make sure, your server php "post_max_size" value is
                                grater
                                or
