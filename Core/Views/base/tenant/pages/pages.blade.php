                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($page->publish_status == config('settings.page_status.publish'))
                                                <a href="{{ url('/') }}/page/{{ $page->permalink }}"
                                                    target="_blank">{{ $page->translation('title', getLocale()) }}
                                                </a>
                                            @else
                                                <a href="{{ url('/') }}/page-preview/{{ $page->permalink }}"
                                                    target="_blank">{{ $page->translation('title', getLocale()) }}
                                                </a>
                                            @endif
                                            —
                                        ...
                                        <td>
                                            @if ($page->parentPage != null)
                                                {{ $page->parentPage->translation('title', getLocale()) }}
                                            @endif
                                        </td>
