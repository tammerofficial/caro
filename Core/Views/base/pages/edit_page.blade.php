            ...
            <div class="col-md-8">
                ...
                <div class="card mb-30">
                    <div class="card-body">
                        ...
                        {{-- Content Field --}}
                        <div
                            class="form-group row my-4 {{ isActivePluging('pagebuilder') && $page->page_type == 'builder' ? 'd-none' : '' }}">
            ...
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-12 @if (!empty($lang) && $lang != getdefaultlang()) area-disabled @endif">
                        ...
                        {{-- Featured Image --}}
                        <div
                            class="card card-body mt-5 page_image {{ isActivePluging('pagebuilder') && $page->page_type == 'builder' ? 'd-none' : '' }}">
            ...
            $.ajax({
                ...
                if (response.error) {
                    ...
                    switch (action) {
                        ...
                        case 'preview':
                            $('#page_id').val(response.id);
                            window.open('/admin/page-preview/' + response.permalink);
                            break;
                        default:
                            toastr.error(response.error, "Error!");
                            break;
