    ...
    <form class="form-horizontal my-4" id="blog_form" action="{{ route('core.update.blog') }}" method="post"
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                @if (getGeneralSetting('enable_blog_ai_assistant') == config('settings.general_status.active'))
                    {{-- AI Assistent --}}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row my-4">
                                <label for="editorial_tone"
                                    class="col-sm-4 font-14 bold black">{{ translate('Language') }}<span
                            ...
                            <div class="form-group row my-4">
                                ...
                                <div class="col-sm-8">
                                    <select class="theme-input-style" id="creativity_level" name="creativity_level">
                                        <option value="1.0">{{ translate('Extra Ordinary') }}</option>
                            ...
                            <div class="form-group row my-4">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="d-flex d-sm-inline-flex align-items-center mr-sm-5 mb-3">
                                        <label class="custom-checkbox position-relative mr-2">
                                            <input type="checkbox" id="short_details" name="short_details"
                                                class="options">
                                            <span class="checkmark"></span>
                                        </label>
                                    ...
                                    <div class="d-flex d-sm-inline-flex align-items-center">
                                        <label class="custom-checkbox position-relative mr-2">
                                            <input type="checkbox" id="blog_details" name="blog_details"
                                                class="options">
                                            <span class="checkmark"></span>
                                        </label>
                            ...
                            <div class="form-group row my-4 d-none">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" name="short_details_length" id="short_details_length"
                                        class="form-control short_details_length"
                                        value="{{ old('short_details_length') }}"
                ...
                <div class="card mb-30">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="font-20">{{ translate('Edit Blog') }}</h4>
                            <div class="d-flex flex-wrap">
                                <a href="{{ route('core.add.blog') }}" class="btn long">{{ translate('Add New') }}</a>
                            </div>
                        </div>
                        ...
                        <div class="form-row my-4">
                            ...
                            <div class="col-sm-10">
                                <textarea name="short_description" class="theme-input-style h-100"
                ...
                <div class="row">
                        ...
                        <div class="card card-body mt-5 mt-md-0 p-3">
                            <div class="@if (!empty($lang) && $lang != getDefaultLang()) area-disabled @endif">
                                ...
                                <div class="mx-1 my-2 d-none" id="visibility_form">
                                    <input type="radio" {{ $blog->visibility == 'public' ? 'checked' : '' }}
                                    ...
                                    <input type="radio" {{ $blog->visibility == 'password' ? 'checked' : '' }}
                                    ...
                                    <span id="password-span" class="ml-4">
                                        <input type="text" name="blog_password" id="blog_password"
                                    ...
                                    <input type="radio" {{ $blog->visibility == 'private' ? 'checked' : '' }}
                    ...
                    <div class="col-12 @if (!empty($lang) && $lang != getDefaultLang()) area-disabled @endif">
                        ...
                        <div class="card card-body mt-md-5  col-12">
                            ...
                            <div class="mx-1 mt-2">
                                <input type="radio" @checked($blog->formate == 'standard') name="formate" id="formate-standard"
                                    value="standard" />
                                <label for="formate-standard" class="mb-1">{{ translate('Standard') }}</label>
                                <br />
                                <input type="radio" @checked($blog->formate == 'video') name="formate" id="formate-video"
                                    value="video" />
                                <label for="formate-video" class="mb-1">{{ translate('Video') }}</label>
                                <br />
                                <input type="radio" @checked($blog->formate == 'audio') name="formate" id="formate-audio"
                                    value="audio" />
                                <label for="formate-audio" class="mb-1">{{ translate('Audio') }}</label>
                                <br />
                                <input type="radio" @checked($blog->formate == 'gallery') name="formate" id="formate-gallery"
                                    value="gallery" />
                        ...
                        {{-- Blog Gallery Image --}}
                        <div class="card card-body mt-5 col-12 @if ($blog->formate !== 'gallery') d-none @endif"
                            id="galler-images">
