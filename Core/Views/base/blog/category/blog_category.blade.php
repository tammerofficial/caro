                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)">
                                                {{ $bcategory->translation('name', getLocale()) }}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <label class="switch glow primary medium">
                                                <input type="checkbox" class="change_publish"
                                                    {{ $bcategory->is_publish == '1' ? 'checked' : '' }} name="is_publish"
                                ...
                                <div class="pagination d-flex flex-column align-items-center">
                                    ...
                                    <ul class="list-inline d-inline-flex align-items-center mb-2">
                                        ...
                                        @if ($current_page - 2 > 0)
                                            <li>
                                                <a
                                                    href="{{ $route . '&page=' . $current_page - 2 }}">
                                                    {{ $current_page - 2 }}</a>
                                            </li>
                                        @endif
                                        ...
                                        @if ($current_page - 1 > 0)
                                            <li>
                                                <a
                                                    href="{{ $route . '&page=' . $current_page - 1 }}">
                                                    {{ $current_page - 1 }}</a>
                                            </li>
                                        @endif
                                        ...
                                        @if ($current_page < $last_page - 2)
                                            ...
                                            <li>
                                                <a
                                                    href="{{ $route . '&page=' . $last_page }}">{{ $last_page }}</a>
                                            </li>
                                        @endif
