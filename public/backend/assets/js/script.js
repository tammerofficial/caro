...
$(
    (function () {
        ...
        function sidebar() {
            if ($(window).width() > 1023) {
                ...
                $(".sidebar .sidebar-toogle-pin").on("click", function () {
                    ...
                    body.find(".sidebar-body .has-sub-item a")
                        .siblings("ul")
                        .removeClass("open")
                        .slideUp("fast");
                });
      ...
      ==============================================*/
        /* Mail Inbox Checkbox */
        let mailListCheckbox = $(".mail-list").find(
        ...
        if (
            $(".mail-header, .project-header, .file-header").find(
                ".custom-checkbox input[type=checkbox]"
            ).length
        ) {
            $(".mail-header, .project-header, .file-header")
        ...
        if ($('.custom-checkbox input[type="checkbox"]').length) {
            ...
            $('.custom-checkbox input[type="checkbox"]').on(
                "click",
                function (e) {
                    e.stopPropagation();
        ...
        let customCheckboxes = $(
            ".project-header, .project-box, .file-header, .file"
        ...
        if (customCheckboxes.length) {
            ...
            customCheckboxes.find('input[type="checkbox"]').change(function () {
                if (
                    customCheckboxes.find('input[type="checkbox"]:checked')
                        .length == 0
                ) {
                    customCheckboxes.hide();
                }
            ...
            $(".project-box, .file")
                ...
                .on("click", function (e) {
                    ...
                    $(this)
                        .parents()
                        .filter(".project-box, .file")
                        .find('.custom-checkbox input[type="checkbox"]')
                        .prop("checked", true);
                });

            $(".project-box, .file")
                .find(".dropdown-button .delete")
                .on("click", function (e) {
                    e.preventDefault();
            ...
            if (options.animateText == true) {
                $({ Counter: 0 }).animate(
                    { Counter: percentageText },
                    {
                        ...
                        step: function () {
                            $progressCount.html(
                                Math.ceil(this.Counter) + "<span>%</span>"
                            );
                        },
                    }
                );
      ...
      ==============================================*/
        $(document).ready(function () {
            ...
            var newDate = new Date(new Date().toLocaleString("en-US", { timeZone: $("#dateTime").data('timezone') }));
            ...
            setInterval(function () {
                ...
                var minutes = new Date(new Date().toLocaleString("en-US", { timeZone: $("#dateTime").data('timezone') })).getMinutes();
            ...
            setInterval(function () {
                ...
                var hours = new Date(new Date().toLocaleString("en-US", { timeZone: $("#dateTime").data('timezone') })).getHours();
      ...
      18: Share comment box
      ==============================================*/
        $("#projectShareModal, #shareModal")
            .find(".share-actions .link-btn")
            .on("click", function (e) {
                e.preventDefault();
      ...
      ==============================================*/
        $(".file")
            .find(".dropdown-button .share")
            .on("click", function () {
                $("#shareModal").modal("toggle");
            });

        $(".file")
            .find(".dropdown-button .details")
            .on("click", function () {
                $("#fileDetails").modal("toggle");
            });

        $(".file")
            .find(".dropdown-button .detete")
            .on("click", function () {
      ...
      ==============================================*/
        $(".file-input").on("change", function () {
            ...
            $(this)
                .parents(".attach-file")
                .siblings(".file_upload, .file_upload2, .file_upload3")
                .text(filename);
        });
      ...
      ==============================================*/
        ...
        $(".p_work-list, .p_education-list")
            ...
            .on("click", function (e) {
                ...
                $(this)
                    .parents(".work-content")
                    .hide()
                    .siblings(".work-update-form")
                    .show();
            });
        ...
        $(".work-update-form")
            .find(".work-form-close")
            .on("click", function () {
                $(this)
                    .parents(".work-update-form")
                    .hide()
                    .siblings(".work-content")
                    .show();
            });
      ...
      ==============================================*/
        ...
        /*============================================
      29: Media Select & DeSelect
      ==============================================*/
        // $("#attachment-list > li").on("click", function (e) {
        //     e.stopPropagation();
        ...
        // $("#attachment-list button.check").on("click", function (e) {
        //     e.stopPropagation();
        //     $(this).parents("li").removeClass("selected");
        //     $(".media-sidebar").removeClass("active");
        // });

        $(".media-sidebar-close > i").on("click", function (e) {
            e.stopPropagation();
            $(".media-sidebar").removeClass("active");
        });
        ...
        $("body").on("click", function (e) {
            if (!$(e.target).is("li") && !$(e.target).is(".media-sidebar *")) {
                $(".media-sidebar").removeClass("active");
            }
        });

        // $(".media-sidebar").on("click", function (e) {
        //     e.stopPropagation();
        //     $(this).addClass("active");
        // });

        /*============================================
      30: Remove Image Button
      ==============================================*/
        // $(".remove-img-btn").on("click", function () {
        //   $(this).parents(".preview-image-wrapper").remove();
        // });
        // $(".btn-trigger-remove-gallery-image").on("click", function () {
        //   $(this).parents(".gallery-image-item-handler").remove();
        // });

        function imgRemove(clickEle, removeEle) {
            $(clickEle).on("click", function () {
                $(this).parents(removeEle).remove();
            });
        }

        imgRemove(".remove-img-btn", ".preview-image-wrapper");
        imgRemove(
        ...
        /*==================================
      31: Increase/Decrease Product Quantity
      ====================================*/
        /* 23.1: Increase */
      ...
      32: color Picker
      ==============================================*/
        $(".colorpicker-input").on("input", function (e) {
            $(this).siblings(".colorpicker-output").val(e.target.value);
        });
        $(".dropdown-prevent")
            .find("input, select")
            .on("click", function (e) {
