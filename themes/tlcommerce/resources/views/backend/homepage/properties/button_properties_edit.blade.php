    ...
    <div class="col-sm-12">
        <div class="input-group addon">
            <input type="text" name="btn_color" class="color-input form-control style--two" placeholder="#fffff"
                value="{{ getHomePageSectionProperties($section_id, 'btn_color') }}">
    ...
    <div class="col-sm-12">
        <div class="input-group addon">
            <input type="text" name="btn_hover_color" class="color-input form-control style--two"
                placeholder="#fffff" value="{{ getHomePageSectionProperties($section_id, 'btn_hover_color') }}">
            <div class="input-group-append">
                <input type="color" class="input-group-text theme-input-style2 color-picker" id="colorPicker"
                    value="{{ getHomePageSectionProperties($section_id, 'btn_hover_color') }}"
                    oninput="selectColor(event,this.value)">
            </div>
        </div>
    ...
    <div class="col-sm-12">
        <div class="input-group addon">
            <input type="text" name="btn_bg_color" class="color-input form-control style--two" placeholder="#fffff"
                value="{{ getHomePageSectionProperties($section_id, 'btn_bg_color') }}">
            <div class="input-group-append">
                <input type="color" class="input-group-text theme-input-style2 color-picker" id="colorPicker"
                    value="{{ getHomePageSectionProperties($section_id, 'btn_bg_color') }}"
                    oninput="selectColor(event,this.value)">
    ...
    <div class="col-sm-12">
        <div class="input-group addon">
            <input type="text" name="btn_bg_hover_color" class="color-input form-control style--two"
                placeholder="#fffff" value="{{ getHomePageSectionProperties($section_id, 'btn_bg_hover_color') }}">
            <div class="input-group-append">
                <input type="color" class="input-group-text theme-input-style2 color-picker" id="colorPicker"
                    value="{{ getHomePageSectionProperties($section_id, 'btn_bg_hover_color') }}"
                    oninput="selectColor(event,this.value)">
            </div>
        </div>
    ...
    <div class="col-sm-12">
        <div class="input-group addon">
            <input type="text" class="form-control radius-0" name="btn_border" placeholder="00"
                value="{{ getHomePageSectionProperties($section_id, 'btn_border') }}">
            <div class="input-group-append">
    ...
    <div class="col-sm-12">
        <div class="input-group addon">
            <input type="text" name="btn_border_color" class="color-input form-control style--two"
                placeholder="#fffff" value="{{ getHomePageSectionProperties($section_id, 'btn_border_color') }}">
            <div class="input-group-append">
                <input type="color" class="input-group-text theme-input-style2 color-picker" id="colorPicker"
                    value="{{ getHomePageSectionProperties($section_id, 'btn_border_color') }}"
                    oninput="selectColor(event,this.value)">
            </div>
        </div>
    ...
    <div class="col-sm-12">
        <div class="input-group addon">
            <input type="text" name="btn_border_hover_color" class="color-input form-control style--two"
                placeholder="#fffff"
                value="{{ getHomePageSectionProperties($section_id, 'btn_border_hover_color') }}">
            <div class="input-group-append">
                <input type="color" class="input-group-text theme-input-style2 color-picker" id="colorPicker"
                    value="{{ getHomePageSectionProperties($section_id, 'btn_border_hover_color') }}"
                    oninput="selectColor(event,this.value)">
