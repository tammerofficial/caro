     ...
     @if (isActivePluging('tlecommercecore'))
         <ul class="nav nav-tabs mb-20" id="myTab" role="tablist">
             ...
             <li class="nav-item">
                 <a class="nav-link" id="button-tab" data-toggle="tab" href="#button" role="tab"
                     aria-controls="button" aria-selected="false">{{ translate('Button') }}</a>
             </li>
             <li class="nav-item">
         ...
         <div class="tab-content" id="myTabContent">
             ...
             <div class="tab-pane fade show active" id="content-info" role="tabpanel"
                 aria-labelledby="content-info-tab">
                         ...
                         @if (count($deals) > 0)
                             <select class="theme-input-style" name="content">
                                 @foreach ($deals as $deal)
                                     <option value="{{ $deal->id }}" @selected(getHomePageSectionProperties($details->id, 'content') == $deal->id)>
                 ...
                 <div class="form-row mb-20">
                     ...
                     <div class="col-sm-12">
                         ...
                         <small>{{ translate('Button title is visible in homepage. Transalate to another language') }}
                             <a href="{{ route('core.languages') }}">{{ translate('click here') }}.</a></small>
                     </div>
                 </div>
