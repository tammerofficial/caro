...
<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade show active" id="content-info" role="tabpanel" aria-labelledby="content-info-tab">
        ...
        <div class="form-row mb-20">
            ...
            <div class="col-sm-12">
                <select class="theme-input-style select-ads-layout" id="adsLayout" name="content">
                    <option value="3_6_3" @selected(getHomePageSectionProperties($details->id, 'content') == '3_6_3')>Layout 3-6-3 Column</option>
                    <option value="6_6" @selected(getHomePageSectionProperties($details->id, 'content') == '6_6')>Layout 6-6 Column</option>
                    <option value="12" @selected(getHomePageSectionProperties($details->id, 'content') == '12')>Layout 12 Column</option>
                    <option value="6_3_3" @selected(getHomePageSectionProperties($details->id, 'content') == '6_3_3')>Layout 6-3-3 Column</option>
                    <option value="3_3_6" @selected(getHomePageSectionProperties($details->id, 'content') == '3_3_6')>Layout 3-3-6 Column</option>
                </select>
