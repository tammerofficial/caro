...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/default/public/assets/css/page_style.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/default/public/assets/css/custom.css') }}">
...
<body
    class="@if ($mood == 'dark') dark @endif @if ($rtl) rtl-mode @endif @if ($currentRoute == 'theme.default.home') home-page @endif">
    <!-- Preloader -->
    ...
    <link rel="stylesheet"
        href="{{ asset('themes/default/public/assets/plugins/magnific-popup/magnific-popup.css') }}">
    ...
    <script type="text/javascript"
        src="{{ asset('themes/default/public/assets/plugins/jquery-lazy/jquery.lazy.min.js') }}"></script>
