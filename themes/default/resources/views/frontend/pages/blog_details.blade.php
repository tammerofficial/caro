@php
    ...
    $related_blogs = getRelatedBlogs($blog->permalink, $related_count);
                            ...
                            <ul class="nav meta align-items-center">
                                @if ($is_author)
                                    ...
                                    <li class="meta-author">
                                        <img src="{{ $variation }}" alt="{{ $author_name }}"
...
@section('custom-js')
    ...
    <script>
        (function($) {
            ...
            let comment_section = '';
            let page = '';
            let blog_visibility = '{{ $blog->visibility }}'
            ...
            $(document).ready(function() {
                ...
                if (blog_visibility == 'password' && cookie_data != null && cookie_data.blog ==
                    '{{ $blog->permalink }}') {
