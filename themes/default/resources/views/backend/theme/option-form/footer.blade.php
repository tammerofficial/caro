...
<div class="form-group row py-3 border-bottom">
    <div class="col-xl-4">
        <label for="footer_content" class="font-16 bold black">{{ translate('Footer Content') }}
        </label>
        <span class="d-block">{{ translate('Footer Content') }}</span>
    </div>
    <div class="col-xl-6 offset-xl-1">
        <textarea name="footer_content" id="footer_content" cols="30" rows="10" class="form-control">
        {{ !empty($option_settings['footer_content']) ? $option_settings['footer_content'] : '' }}
        </textarea>
    </div>
</div>
{{-- Footer Content End --}}
...
<div id="custom_footer_style_switch_on_field">
    ...
    <div class="form-group row py-4 border-bottom">
        ...
        <div class="col-xl-6 offset-xl-1">
            <div class="row ml-2">
                <div class="color">
                    <input type="text" class="form-control" name="footer_color"
                        value="{{ isset($option_settings['footer_color']) ? $option_settings['footer_color'] : '' }}">

                    <input type="color" class="" id="footer_color"
                        value="{{ isset($option_settings['footer_color']) ? $option_settings['footer_color'] : '#fafafa' }}">
                    <label for="footer_color">{{ translate('Select Color') }}</label>
                </div>
                <div class="d-flex align-items-center">
                    <label class="custom-checkbox position-relative ml-2 mr-1">
                        <input type="hidden" name="footer_color_transparent" value="0">
                        <input type="checkbox"
                            {{ isset($option_settings['footer_color_transparent']) && $option_settings['footer_color_transparent'] == 1 ? 'checked' : '' }}
                            name="footer_color_transparent" id="footer_color_transparent" value="1">
                        <span class="checkmark"></span>
                    </label>
                    <label class="black font-16" for="footer_color_transparent">{{ translate('Transparent') }}</label>
                </div>
            </div>
        </div>
    </div>
    {{-- Footer Color Field End --}}

    {{-- Footer Link Field Start --}}
    <div class="form-group row py-4 border-bottom">
        <div class="col-xl-4">
            <label class="font-16 bold black">{{ translate('Footer Link Color') }}
            </label>
            <span class="d-block">{{ translate('Set Footer Link Color') }}</span>
        </div>
        <div class="col-xl-6 offset-xl-1">
            <div class="row ml-2">
                <div class="color">
                    <input type="text" class="form-control" name="footer_link_color"
                        value="{{ isset($option_settings['footer_link_color']) ? $option_settings['footer_link_color'] : '' }}">

                    <input type="color" class="" id="footer_link_color"
                        value="{{ isset($option_settings['footer_link_color']) ? $option_settings['footer_link_color'] : '#fafafa' }}">
                    <label for="footer_link_color">{{ translate('Select Color') }}</label>
                </div>
                <div class="d-flex align-items-center">
                    <label class="custom-checkbox position-relative ml-2 mr-1">
                        <input type="hidden" name="footer_link_color_transparent" value="0">
                        <input type="checkbox"
                            {{ isset($option_settings['footer_link_color_transparent']) && $option_settings['footer_link_color_transparent'] == 1 ? 'checked' : '' }}
                            name="footer_link_color_transparent" id="footer_link_color_transparent" value="1">
                        <span class="checkmark"></span>
                    </label>
                    <label class="black font-16"
                        for="footer_link_color_transparent">{{ translate('Transparent') }}</label>
                </div>
            </div>
        </div>
    </div>
    {{-- Footer Link Color Field End --}}

    {{-- Footer Link Hover Start --}}
    <div class="form-group row py-4 border-bottom">
        <div class="col-xl-4">
            <label class="font-16 bold black">{{ translate('Footer Link Hover Color') }}
            </label>
            <span class="d-block">{{ translate('Set Footer Link Hover Color') }}</span>
        </div>
        <div class="col-xl-6 offset-xl-1">
            <div class="row ml-2">
                <div class="color">
                    <input type="text" class="form-control" name="footer_link_hover_color"
                        value="{{ isset($option_settings['footer_link_hover_color']) ? $option_settings['footer_link_hover_color'] : '' }}">

                    <input type="color" class="" id="footer_link_hover_color"
                        value="{{ isset($option_settings['footer_link_hover_color']) ? $option_settings['footer_link_hover_color'] : '#fafafa' }}">
                    <label for="footer_link_hover_color">{{ translate('Select Color') }}</label>
                </div>
                <div class="d-flex align-items-center">
                    <label class="custom-checkbox position-relative ml-2 mr-1">
                        <input type="hidden" name="footer_link_hover_color_transparent" value="0">
                        <input type="checkbox"
                            {{ isset($option_settings['footer_link_hover_color_transparent']) && $option_settings['footer_link_hover_color_transparent'] == 1 ? 'checked' : '' }}
                            name="footer_link_hover_color_transparent" id="footer_link_hover_color_transparent"
                            value="1">
                        <span class="checkmark"></span>
                    </label>
                    <label class="black font-16"
                        for="footer_link_hover_color_transparent">{{ translate('Transparent') }}</label>
                </div>
            </div>
        </div>
    </div>
    {{-- Footer Link Hover Color Field End --}}
    ...
    <div class="form-group row py-4 border-bottom">
        ...
        <div class="col-xl-6 offset-xl-1 row">
            ...
            <div class="input-group col-xl-4">
                <select class="form-control select" name="custom_footer_padding_unit"
                    id="custom_footer_padding_unit">
                    <option value="px"
    ...
    <div id="footer_text_enable_switch_on_field">
        <div class="form-group row py-4 border-bottom">
            <div class="col-xl-4">
                <label class="font-16 bold black">{{ translate('Copyright Background Color') }}
                </label>
                <span class="d-block">{{ translate('Set Copyright Background Color') }}</span>
            </div>
            <div class="col-xl-6 offset-xl-1">
                <div class="row ml-2">
                    <div class="color">
                        <input type="text" class="form-control" name="copyright_bg_color"
                            value="{{ isset($option_settings['copyright_bg_color']) ? $option_settings['copyright_bg_color'] : '' }}">

                        <input type="color" class="" id="copyright_bg_color"
                            value="{{ isset($option_settings['copyright_bg_color']) ? $option_settings['copyright_bg_color'] : '#fafafa' }}">
                        <label for="copyright_bg_color">{{ translate('Select Color') }}</label>
                    </div>
                    <div class="d-flex align-items-center">
                        <label class="custom-checkbox position-relative ml-2 mr-1">
                            <input type="hidden" name="copyright_bg_color_transparent" value="0">
                            <input type="checkbox"
                                {{ isset($option_settings['copyright_bg_color_transparent']) && $option_settings['copyright_bg_color_transparent'] == 1 ? 'checked' : '' }}
                                name="copyright_bg_color_transparent" id="copyright_bg_color_transparent" value="1">
                            <span class="checkmark"></span>
                        </label>
                        <label class="black font-16"
                            for="copyright_bg_color_transparent">{{ translate('Transparent') }}</label>
                    </div>
                </div>
            </div>
        </div>
