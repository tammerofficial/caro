    ...
    public function saveReviews($request)
    {
        try {
            ...
            $sliders[$request->key] = [
                ...
                'reviewer_image' => [
                    'path' => getFilePath($request->reviewer_image_id),
                    'id' => $request->reviewer_image_id
                ]
            ];
            ...
            return BuilderHelper::jsonResponse(200, translate('Review Saved Successfully'), $data);
        } catch (\Exception $e) {
            DB::rollback();
            return BuilderHelper::jsonResponse(500, translate('Review Saving Failed'));
        }
    }
    ...
    public function deleteReview($request)
    {
        try {
            ...
            if ($layout_widget_properties) {
                ...
                return BuilderHelper::jsonResponse(200, translate('Review Slide Deleted Successfully'));
            }
            ...
            DB::rollBack();
            return BuilderHelper::jsonResponse(500, translate('Review Slide Deleting Failed'));
        }
    }
}
