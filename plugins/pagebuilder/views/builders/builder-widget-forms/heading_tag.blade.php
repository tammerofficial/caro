<ul class="nav nav-tabs mb-20" id="myTab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" id="style-tab" data-toggle="tab" href="#style" role="tab"
            aria-controls="style" aria-selected="true">{{ translate('Style') }}</a>
    </li>
    <li class="nav-item">
...
<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade show active" id="content-info" role="tabpanel" aria-labelledby="content-info-tab">
        @include('plugin/pagebuilder::page-builder.includes.lang-translate', ['lang' => $lang, 'widget' => 'heading_tag'])
        ...
        <div class="form-group mb-3 translate-field">
            ...
            <div class="mt-1">
                <input type="text" name="heading_text_t_" id="heading_text" class="form-control"
                    placeholder="{{ translate('Heading Text') }}"
        ...
        <div class="form-group">
            ...
            <div class="btn-group" data-toggle="buttons">
                <label class="btn btn-primary sm {{ isset($widget_properties['alignment']) && $widget_properties['alignment'] == 'left' ? 'active':'' }}">
                ...
                <label class="btn btn-primary sm {{ isset($widget_properties['alignment']) && $widget_properties['alignment'] == 'center' ? 'active':'' }}">
                ...
                <label class="btn btn-primary sm {{ isset($widget_properties['alignment']) && $widget_properties['alignment'] == 'right' ? 'active':'' }}">
