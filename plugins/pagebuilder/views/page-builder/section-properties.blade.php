...
<div class="tab-content" id="myTabContent">
    ...
    @include('plugin/pagebuilder::page-builder.properties.background-properties', ['properties' => $section_properties])

    <!-- Include Advance Properties -->
    @include('plugin/pagebuilder::page-builder.properties.advance-properties',['properties' => $section_properties])
</div>
