    ...
    <div class="configuration">
        <form id="credential-form">
            ...
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <input type="text" class="theme-input-style" name="mc_pago_access_token"
                        ...
                        value="{{ \Plugin\Saas\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'mc_pago_access_token') }}"
                        required />
                </div>
            </div>
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <input type="text" class="theme-input-style" name="mc_pago_public_key"
                        ...
                        value="{{ \Plugin\Saas\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'mc_pago_public_key') }}"
                        required />
                </div>
            </div>
            ...
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <textarea name="mc_pago_instruction" class="theme-input-style" placeholder="Enter Instruction">{{ \Plugin\Saas\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'mc_pago_instruction') }}</textarea>
                </div>
            </div>
            <div>
