        ...
        <div class="col-md-12">
            <div class="card mb-30">
                ...
                <div class="px-2 filter-area d-flex align-items-center mb-3">
                    <!--Filter area-->
                    <form method="get" action="{{ route('saas.subscriber.support.tickets') }}">
                    ...
                    @if (request()->has('ticket_category') ||
                        ...
                        <a class="btn long btn-danger" href="{{ route('saas.subscriber.support.tickets') }}">
                                    ...
                                    <td class="text-right w-20">
                                        <div class="dropdown-button">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a
                                                    href="{{ route('edit.subscriber.support.tickets', $ticket->id) }}">{{ translate('Edit') }}</a>
                                                <a
                                                    href="{{ route('subscriber.support.ticket.details', $ticket->id) }}">{{ translate('Details') }}</a>
                                                <a href="#"
                            ...
                            @empty
                                <tr>
                                    <td class="text-center" colspan="6">
                                        <p class="alert">No data found in this table</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
