    ...
    <div class="configuration">
        <form id="credential-form">
            ...
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <input type="text" class="theme-input-style" name="gpay_marchant_name"
                        ...
                        value="{{ \Plugin\TlcommerceCore\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'gpay_marchant_name') }}"
                        required />
                </div>
            </div>
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <input type="text" class="theme-input-style" name="gpay_marchant_id"
                        ...
                        value="{{ \Plugin\TlcommerceCore\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'gpay_marchant_id') }}"
                        required />
                </div>
            </div>
            ...
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <textarea name="gpay_instruction" id="instruction" class="theme-input-style">{{ \Plugin\TlcommerceCore\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'gpay_instruction') }}</textarea>
                </div>
            </div>
            <div>
